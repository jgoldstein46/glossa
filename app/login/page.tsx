      ...
      <div className="w-full max-w-md space-y-8">
        <div>
          <h2 className="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">
            Welcome to Glossa Learning
          </h2>
          <p className="mt-2 text-center text-sm text-gray-600">Sign in or create an account</p>
        </div>
        <form action={handleSubmit} className="mt-8 space-y-6">
          ...
          <div>
            <button
              ...
              className="flex items-center hover:cursor-pointer w-full justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus-visible:ring-transparent"
            >
