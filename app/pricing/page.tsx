...
export default function PricingPage() {
  ...
  const handleDowngrade = async () => {
    if (
      !currentSubscription ||
      !confirm(
        "Are you sure you want to cancel your Pro subscription? You will lose access to premium features at the end of your billing cycle.",
      )
    )
      return;
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="p-8 bg-gray-50 rounded-2xl border border-gray-200 flex flex-col">
            ...
            <div className="text-4xl font-bold text-gray-900 mb-6">
              $0<span className="text-lg text-gray-600 font-normal">/mo</span>
            </div>
            ...
            >
              {submitting && currentSubscription
                ? "Processing..."
                : !currentSubscription
                  ? "Current Plan"
                  : "Downgrade"}
          ...
          <div className="p-8 bg-blue-50 rounded-2xl border border-blue-100 relative overflow-hidden flex flex-col">
            ...
            <div className="text-4xl font-bold text-gray-900 mb-6">
              $19<span className="text-lg text-gray-600 font-normal">/mo</span>
            </div>
            <ul className="space-y-4 mb-8 text-gray-600 flex-1">
