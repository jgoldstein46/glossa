...
import type {
  ...
  EvaluateQuizData,
  EvaluateQuizErrors,
  EvaluateQuizResponses,
  GetModuleData,
  GetModuleErrors,
  GetModuleResponses,
  GetModuleSectionsData,
  GetModuleSectionsErrors,
  GetModuleSectionsResponses,
  GetOwnProfileData,
  GetOwnProfileErrors,
  ...
  GetProgressData,
  GetProgressErrors,
  GetProgressResponses,
  GetQuizData,
  GetQuizErrors,
  GetQuizResponses,
  GetQuizResultData,
  GetQuizResultErrors,
  GetQuizResultResponses,
  GetSectionData,
  GetSectionErrors,
  GetSectionQuizData,
  GetSectionQuizErrors,
  GetSectionQuizResponses,
  GetSectionResponses,
  ListModulesData,
  ListModulesErrors,
  ...
  ListQuizResultsData,
  ListQuizResultsErrors,
  ListQuizResultsResponses,
  ListQuizzesData,
  ListQuizzesErrors,
  ListQuizzesResponses,
  ListSectionsData,
  ListSectionsErrors,
  ListSectionsResponses,
  StartModuleData,
  StartModuleErrors,
  StartModuleResponses,
  SubmitQuizResultData,
  SubmitQuizResultErrors,
  SubmitQuizResultResponses,
  UpdateModuleData,
  UpdateModuleErrors,
 ...
 * Get a single module
 */
export const getModule = <ThrowOnError extends boolean = false>(
  options: Options<GetModuleData, ThrowOnError>,
) =>
  (options.client ?? client).get<
    GetModuleResponses,
    GetModuleErrors,
    ThrowOnError
  >({ url: "/modules/{id}", ...options });
 ...
 */
export const getModuleSections = <ThrowOnError extends boolean = false>(
  options: Options<GetModuleSectionsData, ThrowOnError>,
) =>
  (options.client ?? client).get<
    GetModuleSectionsResponses,
    GetModuleSectionsErrors,
    ThrowOnError
  >({ url: "/modules/{id}/sections", ...options });

/**
 * List sections
 */
export const listSections = <ThrowOnError extends boolean = false>(
  options?: Options<ListSectionsData, ThrowOnError>,
) =>
  (options?.client ?? client).get<
    ListSectionsResponses,
    ListSectionsErrors,
    ThrowOnError
  >({ url: "/sections", ...options });
 ...
 */
export const getSectionQuiz = <ThrowOnError extends boolean = false>(
  options: Options<GetSectionQuizData, ThrowOnError>,
) =>
  (options.client ?? client).get<
    GetSectionQuizResponses,
    GetSectionQuizErrors,
    ThrowOnError
  >({ url: "/sections/{id}/quiz", ...options });

/**
 * List quizzes
 */
export const listQuizzes = <ThrowOnError extends boolean = false>(
  options?: Options<ListQuizzesData, ThrowOnError>,
) =>
  (options?.client ?? client).get<
    ListQuizzesResponses,
    ListQuizzesErrors,
 ...
 * Get a single quiz
 */
export const getQuiz = <ThrowOnError extends boolean = false>(
  options: Options<GetQuizData, ThrowOnError>,
) =>
  (options.client ?? client).get<GetQuizResponses, GetQuizErrors, ThrowOnError>(
    { url: "/quizzes/{id}", ...options },
  );
 ...
 */
export const listQuizResults = <ThrowOnError extends boolean = false>(
  options?: Options<ListQuizResultsData, ThrowOnError>,
) =>
  (options?.client ?? client).get<
    ListQuizResultsResponses,
    ListQuizResultsErrors,
 ...
 */
export const submitQuizResult = <ThrowOnError extends boolean = false>(
  options: Options<SubmitQuizResultData, ThrowOnError>,
) =>
  (options.client ?? client).post<
    SubmitQuizResultResponses,
    SubmitQuizResultErrors,
 ...
 */
export const getQuizResult = <ThrowOnError extends boolean = false>(
  options: Options<GetQuizResultData, ThrowOnError>,
) =>
  (options.client ?? client).get<
    GetQuizResultResponses,
    GetQuizResultErrors,
 ...
 */
export const evaluateQuiz = <ThrowOnError extends boolean = false>(
  options: Options<EvaluateQuizData, ThrowOnError>,
) =>
  (options.client ?? client).post<
    EvaluateQuizResponses,
    EvaluateQuizErrors,
 ...
 */
export const startModule = <ThrowOnError extends boolean = false>(
  options: Options<StartModuleData, ThrowOnError>,
) =>
  (options.client ?? client).post<
    StartModuleResponses,
    StartModuleErrors,
 ...
 */
export const getProgress = <ThrowOnError extends boolean = false>(
  options: Options<GetProgressData, ThrowOnError>,
) =>
  (options.client ?? client).get<
    GetProgressResponses,
    GetProgressErrors,
